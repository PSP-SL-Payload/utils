...
def GenerateDocumentation(sourceRepoPath):
    ...
    Parameters:
        sourceRepoPath (string)     - The absolute path to the source repository to generate documentation for.

    Returns:
        bool    - Whether or not the documentation was successfully generated.
    """
...
def RenameHtmlToDocsDir(docsRepoPath):
    ...
    Parameters:
        docsRepoPath (string)     - The absolute path to the documentation repository where the documentation was placed by Doxygen.

    Returns:
        bool    - Whether or not the directory was successfully renamed.
    """
...
def PushDocumentation(docsRepoPath):
    ...
    Returns:
        bool    - Whether or not the repository was successfully pushed to the remote.
    """
